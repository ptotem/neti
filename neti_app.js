...
//                return Router.go("/games_list");
        ...
        ,'click .sign-in': function(e){
            signUp=UI.renderWithData(Template.signInForm);
            UI.insert(signUp, $(".sign-in-form-box")[0]);
            $('.signUp').remove()
        }
...
//                    console.log("correct");
        ...
        'click .sign-up': function(e){
            signIn=UI.renderWithData(Template.signUpForm);
            UI.insert(signIn, $(".sign-in-form-box")[0]);
            $('.signIn').remove()
        }
